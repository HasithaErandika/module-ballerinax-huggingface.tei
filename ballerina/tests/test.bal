...
// Configuration
// ---------------------------------------------------------------------------
configurable string serviceUrl = "http://localhost:9091";
configurable string token = ?;

// Client initialisation (points at the mock listener defined in mock_service.bal)
Client teiClient = check new ({
    auth: {
        token: token
    }
}, "http://localhost:9091");
